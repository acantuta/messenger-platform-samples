...
const APP_SECRET = 'ffc0d6329f4fc268a0b9a213a9a353d3';

// Arbitrary value used to validate a webhook
const PAGE_ACCESS_TOKEN = 'EAAE21alQFX4BAHZCYnijNVGZARy5NdhZBh0G8aq2W1tan1QGwUcZCoZBkdYopovHIP7kHYyjHlR3BddtOKa3lGjqJNxRlxZBviexViBZCnsh0rAC0DrRFQkvtZBtk85LAXpGsBZAVkpZB8qfDuXWKpZC9yKWlZAbGzzoCXNHtWfkeLKGgsEMW6sIoLUd';

// Generate a page access token for your page from the App Dashboard
const VALIDATION_TOKEN = 'forceclosetoken';

// URL where the app is running (include protocol). Used to point to scripts and 
// assets located at this address. 
const SERVER_URL = 'https://forceclose.cantuta.org'
